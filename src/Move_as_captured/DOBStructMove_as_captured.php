<?php
/**
 * File for class DOBStructMove_as_captured
 * @package DOB
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DOBStructMove_as_captured originally named move_as_captured
 ...
 * @date 2015-09-08
 */
class DOBStructMove_as_captured extends DOBWsdlClass
{
    /**
     * The merchantnumber
     * Meta informations extracted from the WSDL
    ...
    public $pwd;
    /**
     * Constructor method for move_as_captured
     ...
     * @param string $_group
     * @param string $_pwd
     * @return DOBStructMove_as_captured
     */
