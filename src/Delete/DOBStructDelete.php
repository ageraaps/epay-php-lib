<?php
/**
 * File for class DOBStructDelete
 * @package DOB
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DOBStructDelete originally named delete
 ...
 * @date 2015-09-08
 */
class DOBStructDelete extends DOBWsdlClass
{
    /**
     * The merchantnumber
     * Meta informations extracted from the WSDL
