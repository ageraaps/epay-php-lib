<?php
/**
 * File for DOBWsdlClass to communicate with SOAP service
 * @package DOB
 ...
 */
/**
 * DOBWsdlClass to communicate with SOAP service
 * 
 * @package DOB
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2015-09-08
 */
class DOBWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://ssl.ditonlinebetalingssystem.dk/remote/payment.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses DOBWsdlClass::setLastError()
     * @uses DOBWsdlClass::initSoapClient()
     * @uses DOBWsdlClass::initInternArrayToIterate()
     * @uses DOBWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'DOBWsdlClass'))
            {
     ...
     * @uses DOBClassMap::classMap()
     * @uses DOBWsdlClass::getDefaultWsdlOptions()
     * @uses DOBWsdlClass::getSoapClientClassName()
     * @uses DOBWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('DOBClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = DOBClassMap::classMap();
     ...
     * If a class is named as {DOB}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('DOBSoapClient') && is_subclass_of('DOBSoapClient','SoapClient'))
            return 'DOBSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses DOBWsdlClass::WSDL_CACHE_WSDL
     * @uses DOBWsdlClass::WSDL_COMPRESSION
     * @uses DOBWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses DOBWsdlClass::WSDL_ENCODING
     * @uses DOBWsdlClass::WSDL_EXCEPTIONS
     * @uses DOBWsdlClass::WSDL_FEATURES
     * @uses DOBWsdlClass::WSDL_LOGIN
     * @uses DOBWsdlClass::WSDL_PASSWORD
     * @uses DOBWsdlClass::WSDL_SOAP_VERSION
     * @uses DOBWsdlClass::WSDL_STREAM_CONTEXT
     * @uses DOBWsdlClass::WSDL_TRACE
     * @uses DOBWsdlClass::WSDL_TYPEMAP
     * @uses DOBWsdlClass::WSDL_URL
     * @uses DOBWsdlClass::VALUE_WSDL_URL
     * @uses DOBWsdlClass::WSDL_USER_AGENT
     * @uses DOBWsdlClass::WSDL_PROXY_HOST
     * @uses DOBWsdlClass::WSDL_PROXY_PORT
     * @uses DOBWsdlClass::WSDL_PROXY_LOGIN
     * @uses DOBWsdlClass::WSDL_PROXY_PASSWORD
     * @uses DOBWsdlClass::WSDL_LOCAL_CERT
     * @uses DOBWsdlClass::WSDL_PASSPHRASE
     * @uses DOBWsdlClass::WSDL_AUTHENTICATION
     * @uses DOBWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses DOBWsdlClass::getSoapClient()
     * @uses DOBWsdlClass::getFormatedXml()
     ...
     * @uses DOBWsdlClass::getSoapClient()
     * @uses DOBWsdlClass::convertStringHeadersToArray()
     ...
     * @uses DOBWsdlClass::getInternArrayToIterate()
     * @uses DOBWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses DOBWsdlClass::getInternArrayToIterateOffset()
     * @uses DOBWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses DOBWsdlClass::getInternArrayToIterateOffset()
     * @uses DOBWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses DOBWsdlClass::getAttributeName()
     * @uses DOBWsdlClass::__toString()
     * @uses DOBWsdlClass::_set()
     * @uses DOBWsdlClass::_get()
     * @uses DOBWsdlClass::setInternArrayToIterate()
     * @uses DOBWsdlClass::setInternArrayToIterateIsArray()
     * @uses DOBWsdlClass::setInternArrayToIterateOffset()
