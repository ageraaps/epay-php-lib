 ...
 */
/**
 * This class stands for DOBStructRenew originally named renew
 ...
 * @date 2015-09-08
 */
class DOBStructRenew extends DOBWsdlClass
{
    /**
     * The merchantnumber
     * Meta informations extracted from the WSDL
     ...
     * @param string $_group
     * @param string $_pwd
     * @return DOBStructRenew
     */
    public function __construct($_merchantnumber,$_transactionid,$_pbsResponse,$_epayresponse,$_group = NULL,$_pwd = NULL)
    {
        parent::__construct(array('merchantnumber'=>$_merchantnumber,'transactionid'=>$_transactionid,'pbsResponse'=>$_pbsResponse,'epayresponse'=>$_epayresponse,'group'=>$_group,'pwd'=>$_pwd),false);
    }
    /**
